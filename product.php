...
<body>
            ...
            <div class="table-wrapper">
                <div class="table-title">
                    <div class="bg-light p-2 m-2">
                        <h5 class="text-dark text-center">Add Product - Penquin</h5>
                    </div>
                    <div class="row">
                        <div class="col-sm-6">
                            <h2>Manage your products here</b></h2>
                        </div>
                        <div class="col-sm-6">
                            <a href="#addProductModal" class="btn btn-success" data-toggle="modal"><i
                                    class="material-icons">&#xE147;</i><span>Add Product</span></a>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body add_product">
                     <div class="form-group">
                        ...
                        <input type="text" id="cat_input" class="form-control" required>
                    </div>
                    <div class="form-group">
                        <label>Name</label>
                    ...
                    <div class="form-group">
                        <label>size</label>
                        <input type="email" id="size_input" class="form-control" required>
                    </div>
                    <div class="form-group">
                        <label>quantity</label>
                   
                        <input type="text" id="quantity_input" class="form-control rounded-0" required pattern="[+-]?([0-9]*[.])?[0-9]+" /> 
                                        <select  id="unit_input" class="form-select rounded-0"  required>
    ...
    <script>
        ...
        function addProduct() {
            var cat = $('.add_product #cat_input').val();
            var name = $('.add_product #name_input').val();
            var size = $('.add_product #size_input').val();
            var quantity = $('.add_product #quantity_input').val();
            var unit = $('.add_product #unit_input').val();
            $.ajax({
                type: 'post',
                data: {
                    cat:cat,
